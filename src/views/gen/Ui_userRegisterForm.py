...
class Ui_userRegisterForm(object):
    def setupUi(self, userRegisterForm):
        ...
        userRegisterForm.setMinimumSize(QtCore.QSize(639, 549))
        userRegisterForm.setMaximumSize(QtCore.QSize(639, 549))
...
"")
        ...
        self.usernameLabel.setGeometry(QtCore.QRect(20, 110, 171, 51))
...
"}")
        ...
        self.passwordLabel.setGeometry(QtCore.QRect(30, 170, 171, 51))
...
"}")
        ...
        self.nameLabel.setGeometry(QtCore.QRect(80, 230, 111, 51))
