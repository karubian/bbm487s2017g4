...
class Ui_GuestSearch(object):
    def setupUi(self, GuestSearch):
        ...
        sizePolicy.setHeightForWidth(GuestSearch.sizePolicy().hasHeightForWidth())
        GuestSearch.setSizePolicy(sizePolicy)
        GuestSearch.setMinimumSize(QtCore.QSize(1154, 834))
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.searchBookWidget_.sizePolicy().hasHeightForWidth())
        self.searchBookWidget_.setSizePolicy(sizePolicy)
        self.searchBookWidget_.setMinimumSize(QtCore.QSize(3, 0))
        self.searchBookWidget_.setStyleSheet("QTableWidget{\n"
"border-radius:0px;\n"
"}")
        self.searchBookWidget_.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.searchBookWidget_.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.searchBookWidget_.setAutoScroll(False)
        ...
        self.searchBookWidget_.setRowCount(2)
        self.searchBookWidget_.setColumnCount(7)
        self.searchBookWidget_.setObjectName("searchBookWidget_")
        item = QtWidgets.QTableWidgetItem()
        self.searchBookWidget_.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.searchBookWidget_.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignVCenter)
        self.searchBookWidget_.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.searchBookWidget_.setItem(0, 5, item)
        self.searchBookWidget_.horizontalHeader().setCascadingSectionResizes(True)
        self.searchBookWidget_.horizontalHeader().setDefaultSectionSize(375)
        self.searchBookWidget_.horizontalHeader().setStretchLastSection(False)
        self.searchBookWidget_.verticalHeader().setCascadingSectionResizes(True)
        self.searchBookWidget_.verticalHeader().setDefaultSectionSize(37)
...
"}")
    ...
    def retranslateUi(self, GuestSearch):
        ...
        self.guestMainFrame.setWhatsThis(_translate("GuestSearch", "<html><head/><body><p>BUrak</p><p><br/></p></body></html>"))
        ...
        item = self.searchBookWidget_.horizontalHeaderItem(0)
        item.setText(_translate("GuestSearch", "New Column"))
        item = self.searchBookWidget_.horizontalHeaderItem(1)
        item.setText(_translate("GuestSearch", "New Column"))
        item = self.searchBookWidget_.horizontalHeaderItem(2)
        item.setText(_translate("GuestSearch", "Published Year"))
        __sortingEnabled = self.searchBookWidget_.isSortingEnabled()
        self.searchBookWidget_.setSortingEnabled(False)
        item = self.searchBookWidget_.item(0, 5)
        item.setText(_translate("GuestSearch", "Published"))
        self.searchBookWidget_.setSortingEnabled(__sortingEnabled)
