...
"}")
        ...
        self.bookTableWidget.setAutoScroll(False)
        ...
        self.bookTableWidget.setTextElideMode(QtCore.Qt.ElideNone)
        self.bookTableWidget.setShowGrid(True)
        self.bookTableWidget.setGridStyle(QtCore.Qt.SolidLine)
        self.bookTableWidget.setCornerButtonEnabled(True)
        self.bookTableWidget.setRowCount(0)
        self.bookTableWidget.setColumnCount(4)
        ...
        self.bookTableWidget.horizontalHeader().setDefaultSectionSize(252)
...
"}")
        ...
        self.userTableWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.userTableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.userTableWidget.setAutoScroll(False)
        ...
        self.userTableWidget.setRowCount(2)
        ...
        self.userTableWidget.horizontalHeader().setDefaultSectionSize(252)
